...
namespace KyBll
{
    ...
    public class SaveDataToDB
    {
        ...
        public static long UploadFsn(string file, ky_gzh_package gzh_package, ky_machine fsnMachine)
        {
            ...
            fsnMachine.business = BussinessType.KHDK;                      
            ...
            if (result)
            {
                ...
                result = KyDataOperation.InsertImportFile(Convert.ToInt64(batchId), fileName, DateTime.Now, fsnMachine.business.ToString(), fsnMachine.kNodeId);
                return batchId;
            }
            else
                return 0;
